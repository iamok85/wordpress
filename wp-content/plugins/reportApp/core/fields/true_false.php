...
class v8supercars_field_true_false extends v8supercars_field
{
	...
	*/
	...
	function __construct()
	{
		...
		$this->label = __("True / False",'v8supercars');
	...
	*/
	...
	{
		// html
		echo '<ul class="v8supercars-checkbox-list ' . $field['class'] . '">';
...
<tr class="field_option field_option_<?php echo $this->name; ?>">
	<td class="label">
		<label><?php _e("Message",'v8supercars'); ?></label>
		<p class="description"><?php _e("eg. Show extra content",'v8supercars'); ?></a></p>
	</td>
	<td>
		<?php 
...
new v8supercars_field_true_false();
