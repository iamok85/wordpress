...
class v8supercars_field_user extends v8supercars_field
{
	/*
	*  __construct
	*
	...
	*/
	...
	function __construct()
	{
		// vars
		$this->name = 'user';
		$this->label = __("User",'v8supercars');
	...
	*/
	...
	function create_field( $field )
	{
		...
		// filters
		$args = apply_filters('v8supercars/fields/user/query', $args, $field, $options['post_id']);
		$args = apply_filters('v8supercars/fields/user/query/name=' . $field['_name'], $args, $field, $options['post_id'] );
		$args = apply_filters('v8supercars/fields/user/query/key=' . $field['key'], $args, $field, $options['post_id'] );
...
<tr class="field_option field_option_<?php echo $this->name; ?>">
	<td class="label">
		<label><?php _e( "Filter by role", 'v8supercars' ); ?></label>
	</td>
	<td>
		<?php 
		
		$choices = array('all' => __('All', 'v8supercars'));
		$editable_roles = get_editable_roles();
