...
class v8supercars_acf_field_image extends v8supercars_field
{
	...
	*/
	...
	function create_field( $field )
	{
		...
		?>
<div class="v8supercars-image-uploader clearfix <?php echo $o['class']; ?>" data-preview_size="<?php echo $field['preview_size']; ?>" data-library="<?php echo $field['library']; ?>" >
	<input class="v8supercars-image-value" type="hidden" name="<?php echo $field['name']; ?>" value="<?php echo $field['value']; ?>" />
	<div class="has-image">
		<div class="hover">
			<ul class="bl">
				<li><a class="v8supercars-button-delete ir" href="#"><?php _e("Remove",'v8supercars'); ?></a></li>
				<li><a class="v8supercars-button-edit ir" href="#"><?php _e("Edit",'v8supercars'); ?></a></li>
			</ul>
		</div>
		<img class="v8supercars-image-image" src="<?php echo $o['url']; ?>" alt=""/>
	</div>
	<div class="no-image">
		<p><?php _e('No image selected','v8supercars'); ?> <input type="button" class="button add-image" value="<?php _e('Add Image','v8supercars'); ?>" />
	</div>
</div>
		<?php
	}
...
new v8supercars_acf_field_image();
