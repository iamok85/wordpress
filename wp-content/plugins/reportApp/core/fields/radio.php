...
class v8supercars_field_radio extends v8supercars_field
{
	/*
	*  __construct
	*
	...
	*/
	...
	function __construct()
	{
		// vars
		$this->name = 'radio';
		$this->label = __("Radio Button",'v8supercars');
	...
	*/
	...
	function create_field( $field )
	{
		// vars
		$i = 0;
		$e = '<ul class="v8supercars-radio-list ' . esc_attr($field['class']) . ' ' . esc_attr($field['layout']) . '">';
		...
		if( $field['other_choice'] )
		{
			...
			$e .= '<li><label><input id="' . esc_attr($field['id']) . '-other" type="radio" name="' . esc_attr($field['name']) . '" value="other" ' . $atts . ' />' . __("Other", 'v8supercars') . '</label> <input type="text" ' . $atts2 . ' /></li>';
		}
	...
	function create_options( $field )
	{
		...
		<tr class="field_option field_option_<?php echo $this->name; ?>">
			<td class="label">
				...
				<p class="description"><?php _e("Enter your choices one per line",'v8supercars'); ?><br />
				<br />
				<?php _e("Red",'v8supercars'); ?><br />
				<?php _e("Blue",'v8supercars'); ?><br />
				<br />
				<?php _e("red : Red",'v8supercars'); ?><br />
				<?php _e("blue : Blue",'v8supercars'); ?><br />
				</p>
			</td>
			<td>
				<?php
				...
				do_action('v8supercars/create_field', array(
					...
					'message'	=>	__("Add 'other' choice to allow for custom values", 'v8supercars')
				));
				...
				do_action('v8supercars/create_field', array(
					...
					'message'	=>	__("Save 'other' values to the field's choices", 'v8supercars')
				));
		...
		<tr class="field_option field_option_<?php echo $this->name; ?>">
			<td class="label">
				<label for=""><?php _e("Layout",'v8supercars'); ?></label>
			</td>
			<td>
				<?php
				...
				do_action('v8supercars/create_field', array(
					...
					'layout' => 'horizontal', 
					'choices' => array(
						'vertical' => __("Vertical",'v8supercars'), 
						'horizontal' => __("Horizontal",'v8supercars')
					)
				));
	...
	function update_value( $value, $post_id, $field )
	{
		...
		if( $field['save_other_choice'] )
		{
			...
			if( !isset($field['choices'][ $value ]) )
			{
				...
				{
					do_action('v8supercars/update_field', $field, $field['field_group']);
				}
