...
class v8supercars_field_text extends v8supercars_field
{
	...
	*/
	...
	function __construct()
	{
		// vars
		$this->name = 'text';
		$this->label = __("Text",'v8supercars');
		$this->defaults = array(
			'default_value'	=>	'',
			'formatting' 	=>	'html',
			'maxlength'		=>	'',
	...
	*/
	...
	{
		if(isset($field['integer'])&&$field['integer']){
						
			$field['class']=$field['class'].' number';
		}
		
		if(isset($field['url'])&&$field['url']){
						
			$field['class']=$field['class'].' url';
		}
