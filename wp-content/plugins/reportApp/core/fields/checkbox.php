...
class v8supercars_field_checkbox extends v8supercars_field
{
	...
	*/
	...
	function __construct()
	{
		// vars
		$this->name = 'checkbox';
		$this->label = __("Checkbox",'v8supercars');
	...
	*/
	...
	function create_field( $field )
	{
		...
		$e .= '<ul class="v8supercars-checkbox-list ' . esc_attr($field['class']) . ' ' . esc_attr($field['layout']) . '">';
...
new v8supercars_field_checkbox();
